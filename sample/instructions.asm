...
1. main:   nop # Starting point of the program
        nop
...
{ program: "instructions.asm", instructions: [
    { segment: ".txt", address: 0x1000, [

//      {line: 13, "label: "main", "op": "nop", argc: 3, args: [ "", "", "" ] }, "comment": "# Comment String" },


        {line: 13, "label: "main", format: S, "op": "nop",   count: 1,  rd: "", rs: "", rt: "", imm: "", "comment": "# Comment String" },},
        {line: 14, "label: "",     format: s, "op": "nop",   count: 1,  rd: "", rs: "", rt: "", imm: "" },

        {line: 16, "label: "",     format: I, "op": "addiu", count: 1, rd: "$t2", rs: "$0", rt: "", imm: "2" },
        {line: 17, "label: "",     format: S, "op": "",      count: 1, rd: "", rs: "", rt: "", imm: "" },
        {line: 18, "label: "",     format: S, "op": "nop",   count: 1, rd: "", rs: "", rt: "", imm: "" },

        {line: 19, "label: "",     format: R, op": "addu",   count: 1, rd: "$t2", rs: "$zero", rt: "2", imm: "" },

        {line: 20, "label: "",     format: B, "op": "",      count: 1, rd: "", rs: "", rt: "", imm: "" },
        {line: 21, "label: "loop", format: S, "op": "",      count: 1, rd: "", rs: "", rt: "", imm: "" },
 
        {line: 22, "label: "top",  format: S, "op": "nop",   count: 1, rd: "", rs: "", rt: "", imm: "" },
 
        {line: 23, "label: "",     format: R, "op": "slt",   count: 1, rd: "$1", rs: "$t6", rt: "$t7", imm: "" },
        {line: 23, "label: "",     format: I, "op": "beq",   count: 2, rd: "$1", rs: "$zero", rt: "", imm: "done" },


        {line: 24, "label: "",     format: I, "op": "sw",  count: 1, rd: "", rs: "", rt: "", imm: "" },
        {line: 25, "label: "",     format: I, "op": "lw",  count: 1, rd: "", rs: "", rt: "", imm: "" },
        {line: 26, "label: "",     format: P, "op": "nop", count: 1, rd: "", rs: "", rt: "", imm: "" },
        {line: 27, "label: "",     format: R, "op": "addi",count: 1, rd: "$t6", rs: "$t6", rt: "", imm: "1" },
        {line: 28, "label: "",     format: J, "op": "j",   count: 1, rd: "", rs: "", rt: "", imm: "" },
        {line: 29, "label: "done", format: S, "op": "nop", count: 1, rd: "", rs: "", rt: "", imm: "" },
]
}
...
text_overlay ->  { "segment": ".text", "alignment": "on", "wordsize": 4, "endianness": "big", start": 0x0040 000, "size": N, "values": [
